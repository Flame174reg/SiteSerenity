        ...
        <div className="space-y-10">
          ...
          <section id="p1" className="space-y-4 scroll-mt-24">
            ...
            <ul className="list-disc pl-6 space-y-2 leading-relaxed marker:text-gray-500">
              ...
              <li>1.2. Список запретов является прецедентным и может быть дополнен или изменён. Наказание назначается по усмотрению старшего состава в зависимости от ситуации.</li>
              <li>1.3. Уважение обязательно ко всем участникам семьи и окружающим.</li>
              <li>1.4. Каждый участник обязан помогать другим в пределах разумного: советом, ресурсами или информацией.</li>
              <li>1.5. Уход из семьи осуществляется с предварительным уведомлением старшего состава.</li>
              <li>1.6. Участники могут предлагать идеи по развитию структуры, мероприятий и системы повышения. Вклад в развитие семьи поощряется.</li>
              <li>1.7. Вступление в семью разрешено только с 18 лет.</li>
              <li>1.8. Вся информация о семье и её действиях является конфиденциальной и не подлежит разглашению.</li>
              <li>1.9. Карьерный рост осуществляется по системе рангов. Исключения возможны только при значительном личном вкладе.</li>
              <li>1.10. Каждый участник несёт ответственность за свои действия как внутри семьи, так и за её пределами.</li>
              <li>1.11. Каждый новый участник обязан пройти вводный инструктаж под руководством старшего состава.</li>
              <li>1.12. Участник, покидающий семью без согласования дважды и более, заносится в чёрный список и не имеет права на повторное вступление.</li>
              <li>1.13. Наказания выдаются старшим составом с учётом обстоятельств, тяжести нарушения и с опорой на рецидивы.</li>
              <li>1.14. Если игрок выходит с официального Discord-сервера семьи, он автоматически исключается из семьи в игре.</li>
            </ul>
          </section>
          ...
          <section id="p2" className="space-y-4 scroll-mt-24">
            ...
            <ul className="list-disc pl-6 space-y-2 leading-relaxed marker:text-gray-500">
              ...
              <li>2.6. Запрещено парковать транспорт в других местах. Если автомобиль взят из гаража дома или офиса, его необходимо вернуть обратно в тот гараж откуда была взята машина.</li>
            </ul>
          </section>
