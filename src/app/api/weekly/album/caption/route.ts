// src/app/api/weekly/album/caption/route.ts
...
export async function POST(req: Request) {
  try {
    ...
    const body = (await req.json().catch(() => null)) as { safe?: string; caption?: string } | null;
    ...
    return NextResponse.json({ ok: true, safe, caption });
  } catch (e) {
